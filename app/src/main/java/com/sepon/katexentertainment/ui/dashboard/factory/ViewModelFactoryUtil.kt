...
import com.sepon.katexentertainment.ui.details.factory.DetailsViewModelFactory
...
object ViewModelFactoryUtil {
    ...
    fun provideMovieDetailsFactory(fragment: Fragment) : DetailsViewModelFactory {
        val repository = MovieSearchRepository(fragment.requireContext().applicationContext as Application)
